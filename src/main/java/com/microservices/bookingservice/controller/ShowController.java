...
public class ShowController {
	...
	public List<ShowSeatsDto> getAvailableSeatsByShow(@PathVariable("showId") Long showId){
		log.info("Received Request to show Available Seats for show: " + showId);
		return showService.getAvailableSeatsByShows(showId);
		}
